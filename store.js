...
ListStore = {
  ...
  loadItems: function() {
    var loadRequest = $.ajax({
      type: 'GET',
      url: "http://listalous.herokuapp.com/lists/JXC-LIST"
    })
  ...
  addItem: function(itemDescription) {
    var creationRequest = $.ajax({
      type: 'POST',
      url: "http://listalous.herokuapp.com/lists/JXC-LIST/items",
  ...
  toggleCompleteness: function(itemId) {
    ...
    var updateRequest = $.ajax({
      type: 'PUT',
      url: "http://listalous.herokuapp.com/lists/JXC-LIST/items/" + itemId,
